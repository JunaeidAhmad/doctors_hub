...
const HOSPITAL_SPECIALTIES = HOSPITAL_CATEGORIES;
...
const DIAGNOSTIC_CENTER_CATEGORIES = [
...
let testCounter = 1;
Object.entries(TEST_TREE).forEach(([topCatName, testList]) => {
...
const PATHOLOGY_CATEGORIES = TEST_CATEGORIES;
...
const DOCTOR_CHAMBERS = DIAGNOSTIC_CENTERS;
const OPD_CHAMBERS = DOCTOR_CHAMBERS;

const PATHOLOGY_TESTS = TESTS;

const DIAGNOSTIC_CENTER_TESTS = [
...
const BRANCH_TESTS = DIAGNOSTIC_CENTER_TESTS;
